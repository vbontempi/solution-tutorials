...
1. Ensure you have the right permissions assigned to manage the service instance by following [these instructions](/docs/Activity-Tracker-with-LogDNA?topic=logdnaat-iam_manage_events#admin_account_opt1).
