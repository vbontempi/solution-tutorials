...
{: #ios-mobile-push-analytics-8}
   ...
   2. Double-click the downloaded provisioning profile to install it into Xcode.
     After obtaining the credentials, the next step is to [Configure a service instance](https://{DomainName}/docs/mobilepush?topic=mobilepush-push_step_2#enable-push-ios-notifications).
