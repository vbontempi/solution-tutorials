...
2. Click on the **Access Management** tab to create new service credentials.
...
Create an instance of [{{site.data.keyword.iae_short}}](/catalog/services/analytics-engine){: external}:
1. Select a region, then the **Standard Serverless for Apache Spark** plan.
